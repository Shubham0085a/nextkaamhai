            ...
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 lg:w-4/12 xl:w-3/12">
                <div className="mb-8 max-w-[320px]">
                  ...
                  <p className="text-base text-body">
                    Powered by <Link href="https://www.offbeatx.com/" target="_blank"
                        rel="noopener noreferrer" className="inline bg-gradient-4 bg-clip-text text-transparent">Offbeat Technet Pvt Ltd</Link>
                  </p>
                </div>
              </div>
              ...
              <div className="w-full px-4 lg:w-4/12 xl:w-3/12">
                <div className="max-w-[320px]">
                  ...
                  <p className="text-base text-body">
                  <Link href="mailto:info@kaamhai.in" className="inline-block">
                  ...
                  <div>
                  <div className="mb-4 flex items-center justify-center space-x-5 md:mb-0 md:justify-start lg:justify-start">
                <Link
