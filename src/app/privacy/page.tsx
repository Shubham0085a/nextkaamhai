...
const PrivacyPolicy = () => {
  return (
    <div className="py-28 px-20 space-y-5">
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-3xl font-semibold">Privacy Policy</h1>
        <p className="text-sm">Last updated: May 25, 2024</p>
      </div>
            ...
            <ul className="list-disc">
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to OFFBEAT TECHNET
                  PRIVATE LIMITED, HD-428, WeWork Prestige, Atlanta, 80 Feet,
                  Koramangala, Bangalore South, Bangalore- 560034 IN.
                </p>
              </li>
              <li>
                <p>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <ul>
            <li>
              <p>By email: <a href="mailto:connect@kaamhai.in" className="font-semibold italic">connect@kaamhai.in</a></p>
            </li>
            <li>
              <p>By phone number: <a href="tel:+917090151000" className="font-semibold italic">7090 151 000</a></p>
            </li>
          </ul>
        </div>
      </div>
